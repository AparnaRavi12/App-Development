...
public class ConsoleUI {
    ...
    private static void addProduct() {
        ...
        System.out.println("Enter the product source:");
    ...
    private static void addReview() {
        System.out.println("Enter the product ID for which you want to add a review:");
    ...
    private static void updateProduct() {
        ...
        System.out.println("Enter the updated product source:");
        String source = scanner.nextLine();
