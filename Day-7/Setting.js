...
function Setting(){
    return(
      ...
      <div className="table">
        <div className="row">
          <div className="cell"><i className="fa fa-tachometer" aria-hidden="true" />One click login</div>
          <div className="cell">
            <fieldset>
              <input type="checkbox" id="One click login" name="One click login" defaultValue={3} />
              <label htmlFor="One click login" />
            </fieldset>
          </div>
        </div>
      </div>
